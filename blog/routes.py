...
from blog.forms import (RegistrationForm, LoginForm, UpdadeAccountForm,
                        PostForm, ResetPasswordForm, RequestResetFrom)
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your message have been update!', 'success')
...
def delete_post(post_id):
    ...
    db.session.commit()
    flash('Your message have been deleted!', 'success')
    return redirect(url_for('home'))
...
def send_reset_email(user):
    ...
    msg.body = f''' To reset your password, visit the following link:
                ...
                email and no change will occur.
                '''
    mail.send(msg)
